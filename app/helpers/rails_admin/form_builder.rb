    ...
    def field_wrapper_for field, nested_in
      if field.label
        ...
        unless field.inverse_of.presence && field.inverse_of == nested_in &&
          ...
          @template.content_tag(:div, :class => "control-group #{field.type_css_class} #{field.css_class} #{'error' if field.errors.present?} #{'onlyread' if field.read_only?}", :id => "#{dom_id(field)}_field") do
