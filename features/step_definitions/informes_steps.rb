Given(/^one of them has an attached PDF$/) do
...
Then(/^the first one should be the most urgent one$/) do
...
Then(/^I should see the list updated and sorted without reloading the page$/) do
